...
class SportsDetailedScreen extends StatefulWidget {
  const SportsDetailedScreen({Key? key,required this.index, required this.title}) : super(key: key);

  final index;
  final title;

  @override
  _SportsDetailedScreenState createState() =>
      _SportsDetailedScreenState(index: index, title: title);
}

class _SportsDetailedScreenState extends State<SportsDetailedScreen> {
  _SportsDetailedScreenState({this.index, required this.title});
